<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Allievi_Gravita.aspx.cs" Inherits="UST.Inclusione.GestioneCattedre.GestioneGravita.Allievi_Gravita" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron" style="background-color: lightgreen; border: inherit">
        <h1>Gravità</h1>
        <hr style='width: 100%' />
        <p class="btn btn-default">Gestione Gravità Allievi.</p>
    </div>
    <div style="width: 100%;">
        ...
        <asp:GridView ID="gridViewAllievi"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Gravita" HeaderText="Gravità"
                   ...
                   <asp:HyperLinkField HeaderText="Gestione Gravità" Text="Modifica" DataNavigateUrlFields="ID"
            DataNavigateUrlFormatString="Allievo_Gravita.aspx?ID={0}" />   
            </Columns>
        </asp:GridView>
